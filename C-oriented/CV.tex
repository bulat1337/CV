...
\section{Проекты}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Реализовал возможность дополнения базы данных, если акинатор не угадает объект.}
            \resumeItem{Добавил опции описания и сравнения объектов из базы данных.}
          \resumeItemListEnd
    \resumeProjectHeading
          {\textbf{List} $|$ \emph{C, Make, Git, Graphviz}}
          {\href{https://github.com/bulat1337/List}{\underline{github.com/bulat1337/List}}}
          \resumeItemListStart
            \resumeItem{Реализовал двусвязный список.}
            \resumeItem{Использовал Graphviz для графического представления списка.}
            \resumeItem{Оптимизировал список для кэш-френдли использования.}
          \resumeItemListEnd
    \resumeProjectHeading
          {\textbf{Stack} $|$ \emph{C, Make, Git}}
          {\href{https://github.com/bulat1337/Stack}{\underline{github.com/bulat1337/Stack}}}
          \resumeItemListStart
            \resumeItem{Реализовал канареечную защиту и хэширование данных.}
            \resumeItem{Оптимизировал стек для кэш-френдли использования.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
